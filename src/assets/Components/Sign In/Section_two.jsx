...
const Section_two = () => {
  return (
    <div className='bg-[#FF6E1C] w-[100%] flex items-center justify-center flex-col py-[200px] px-[20px] h-[100vh] signupform'>
        <div id="image" className="flex flex-row align-center justify-center">
