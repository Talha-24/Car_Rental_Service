    ...
    <div className="w-[100%] bg-[#FFFFFF] flex flex-col items-center justify-center h-[100vh] text-center px-[70px] mail">
        <form onSubmit={(e)=>[e.preventDefault()]}>
                ...
                <div className="w-[100%] flex flex-row gap-[2vmin] py-[4vmin] ">
                   <input  placeholder="-" type="number" name="" id=""  className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] text-black text-center border-[1px] border-gray-500  rounded-lg"/>
                   <input  placeholder="-" type="number" name="" id="" className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] text-black text-center border-[1px] border-gray-500  rounded-lg" />
                   <input  placeholder="-" type="number" name="" id=""  className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] text-black text-center border-[1px] border-gray-500  rounded-lg"/>
                   <input  placeholder="-" type="number" name="" id="" className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] text-black text-center border-[1px] border-gray-500  rounded-lg" />
                   <input  placeholder="-" type="number" name="" id="" className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] text-black text-center border-[1px] border-gray-500  rounded-lg" />
                   <input  placeholder="-" type="number" className="placeholder:font-semibold placeholder:text-center w-[12vmin] py-[2.5vmin] rounded-lg text-black border-[1px] border-gray-500" />
