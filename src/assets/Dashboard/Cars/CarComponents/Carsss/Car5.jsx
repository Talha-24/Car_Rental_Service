...
</svg><p className='text-[#90A3BF] text-[12px]'>{Car.mileage}</p>
</div>
...
</svg><p className='text-[#90A3BF] text-[12px] capitalize'>{Car.feature}</p>
</div>
...
</svg><p className='text-[#90A3BF] text-[12px] capitalize'>{Car.driverType}</p>
</div>
    </div>
