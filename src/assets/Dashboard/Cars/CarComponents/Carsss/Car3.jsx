...
const Car3 = (propse) => {
  ...
  return (
    <div className='w-[23.2%] h-[300px] border-[1px] border-[#dadada]  text-black bg-[#ffffff] rounded-lg flex flex-col justify-between p-[10px] cartwo'>
      <div id="logo" className='flex flex-row justify-between  items-center'><b>{propse.showroom.title}</b>
      ...
      <img className="my-8 w-[30vmin] h-[20vmin] object-cover" src={propse.showroom ? 'http://localhost:5000/' + propse.showroom.pictures[0] : 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg'} alt="" />
      ...
      <div id="carinfo" className='flex flex-row items-center gap-[1vmin]'>
        <div className='flex flex-row items-center justify-evenly w-[100%]'>
          ...
          </svg><p className='text-[#90A3BF] text-[12px] capitalize'>{propse.showroom.fuelType}</p>
        </div>
        ...
        <div className='flex flex-row items-center justify-evenly w-[100%]'>
          ...
          </svg><p className='text-[#90A3BF] text-[12px] capitalize'>{propse.showroom.feature}</p>
        </div>
        ...
        <div className='flex flex-row items-center justify-evenly w-[100%]'>
          ...
          </svg><p className='text-[#90A3BF] text-[12px] capitalize'>{propse.showroom.driverType}</p>
        </div>
      </div>
      <div className='flex flex-col gap-[1vmin]  w-[100%]'>
        <p className='font-bold w-[100%] inline-block capitalize'> {propse.showroom.discountedPrice}/day</p>
