...
const Car1 = (propse) => {
  ...
  let turn = true;
  return (
    <div className='w-[30%] bg-[white] text-black border-[1px] border-[#dadada]  rounded-lg flex flex-col justify gap-[10px] p-[3vmin]'>
      <div id="logo" className='flex flex-row justify-between  items-center'><b>{propse.car.title ?? propse.bookedCar.title}</b>
      ...
      <img className=" w-[100%] h-[120px] object-cover" src={'http://localhost:5000/' + (propse.car?.pictures?.[0] ?? propse.bookedCar.pictures[0])}
        alt="" />
      ...
      <div id="carinfo" className='flex flex-row items-center gap-[1vmin]'>
        <div className='flex flex-row items-center gap-[0.5vw] justify-evenly w-[100%]'>
          ...
          <p className='text-[#90A3BF] text-[12px] capitalize'>{propse.car.fuelType ?? propse.bookedCar.fuelType}</p>
        </div>
        ...
        <div className='flex flex-row items-center  gap-[0.5vw] justify-evenly w-[100%]'>
          ...
          </svg><p className='text-[#90A3BF] text-[12px] capitalize'>{propse.car.driverType ?? propse.bookedCar.driverType}</p>
        </div>
      </div>
      <div className='flex flex-col gap-[1vmin] w-[100%]'>
        <p className='font-bold w-[100%] text-[12px] inline-block'>{propse.car.discountedPrice ?? propse.bookedCar.discountedPrice}/day</p>
