        ...
        <form onSubmit={(e) => { e.preventDefault() }} className="w-[100%] min-h-[300px] bg-[#FFFFFF] rounded py-[2em] flex flex-col items-center justify-around dd">
            <div className="w-[100%] min-h-[300px] bg-[#FFFFFF] rounded py-[2em] px-[2vmin] flex flex-row justify-around dd">
                <div className="flex flex-col gap-[1vmin] dd parent w-[50%] px-[6vmin]">
                    ...
                    <input onChange={(e) => { setusercnic(e.target.value) }} value={usercnic} className="py-[1vmin] px-[2vmin] text-[2.5vmin]  w-[50%] border-[1px] bg-[#F6F7F9] rounded-[1vmin]" placeholder="00000000000" type="number" />
                    <label htmlFor="" className=" text-black inline-block font-semibold text-[2.5vmin]">Guarantier Name</label>
                    <input onChange={(e) => { setguarantiername(e.target.value) }} value={guarantiername} className="py-[1vmin] px-[2vmin] text-[2.5vmin]  w-[50%] border-[1px] bg-[#F6F7F9] rounded-[1vmin]" placeholder="Abdul Rauf" type="text" />
            ...
            <div>
                <button onClick={() => { userData() }} className="py-[1.5vmin] px-[2vmin] w-[100%] bg-[#FF5C00] rounded-[1vmin] text-[2.5vmin] text-white">Rent Now!</button>
            </div>
