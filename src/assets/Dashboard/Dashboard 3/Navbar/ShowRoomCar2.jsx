...
const ShowRoomCar2 = () => {
    return (
        <div className='py-[1vmin]  flex flex-row  gap-[4vmin]  px-[6vmin] w-[100%]' id='carcontainer' >
            ...
            <div className='w-[50%] h-[100%]    text-black bg-[#FFFFFF] rounded-lg flex flex-col justify-between p-[10px]'>

<img className="w-[100%] h-[50%]" src="src\assets\Dashboard\Dashboard 3\Navbar\Show Room Cars\unsplash_9kixbx1zdMw-1.png" alt="" />
...
<div className='flex flex-col  w-[100%] items-end'>
    ...
    <button className='py-[1.3vmin] px-[1.2vmin] bg-[#FF5C1E] rounded-sm text-white font-semibold text-[2.5vmin] w-[48%]'>View</button>
                ...
                <div className='w-[50%] h-[100%] border-[1px]  text-black bg-[#FFFFFF] rounded-lg flex flex-col justify-between p-[10px]'>
                    ...
                    <img className="w-[100%] h-[50%]" src="src\assets\Dashboard\Dashboard 3\Navbar\Show Room Cars\unsplash_9kixbx1zdMw-2.png" alt="" />
            ...
            <div className='flex flex-row items-center gap-[4vmin] w-[100%]'>
                <div className='w-[50%] h-[100%] border-[1px]   text-black bg-[#ffffff] rounded-lg flex flex-col justify-between p-[10px]'>
                    ...
                    <img className="w-[100%] h-[50%]" src="src\assets\Dashboard\Dashboard 3\Navbar\Show Room Cars\unsplash_9kixbx1zdMw-3.png" alt="" />
...
<img className="w-[100%] h-[50%]" src="src\assets\Dashboard\Dashboard 3\Navbar\Show Room Cars\unsplash_9kixbx1zdMw.png" alt="" />
