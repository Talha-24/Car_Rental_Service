...
const Logout = () => {
    return (
      <div className="flex flex-row gap-[4px] py-[6px] px-[1.4vmin] rounded mt-[2.5vmin]">
         <span id="svg">
         <svg onClick={()=>{window.location.reload()}} className="w-[4vmin] h-[5vmin]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
